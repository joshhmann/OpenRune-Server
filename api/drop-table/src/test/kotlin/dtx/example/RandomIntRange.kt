...
@JvmInline
value class RandomIntRange(val wrappedRange: IntRange) :
    ClosedRange<Int> by wrappedRange,
    OpenEndRange<Int> by wrappedRange,
    Iterable<Int> by wrappedRange {

    override val start: Int
        get() = wrappedRange.first

    override val endInclusive: Int
        get() = wrappedRange.endInclusive
