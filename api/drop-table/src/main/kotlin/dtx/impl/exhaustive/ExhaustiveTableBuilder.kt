...
public abstract class ExhaustiveTableBuilder<T, R, Table : ExhaustiveTable<T, R>> :
    ...
    public open infix fun Int.rolls(
        rollable: dtx.core.Rollable<T, R>
    ): ExhaustiveTableBuilder<T, R, Table> {
    ...
    public open infix fun Int.rolls(
        block: ExhaustiveRollableBuilder<T, R>.() -> Unit
    ): ExhaustiveTableBuilder<T, R, Table> {
...
public open class UniformExhaustiveTableBuilder<T, R> :
    ExhaustiveTableBuilder<T, R, ExhaustiveTableImpl<T, R>>() {
...
) : WeightedExhaustiveTable<T, R>, WeightedTableImpl<T, R>(tableIdentifier, tableEntries, hooks) {
...
public open class WeightedExhaustiveTableBuilder<T, R> :
    ExhaustiveTableBuilder<T, R, WeightedExhaustiveTable<T, R>>() {
