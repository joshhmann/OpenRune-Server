...
@JvmField
public val corruptedWolfDropTable: RSDropTable<Player, DropRollItem> =
    RSDropTable(
        tableIdentifier = "Corrupted Wolf Drops",
        npcs = npcs("npc.crystal_wolf_hm"),
        guaranteed = rsPlayerGuaranteedTable { "obj.gauntlet_crystal_shard_hm" count 50..100 },
        mainTable =
            rsPlayerWeightedTable(total = 21) {
                name("Corrupted Wolf Drops")
