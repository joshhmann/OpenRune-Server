...
@JvmField
public val corruptedUnicornDropTable: RSDropTable<Player, DropRollItem> =
    RSDropTable(
        tableIdentifier = "Corrupted Unicorn Drops",
        npcs = npcs("npc.crystal_unicorn_hm"),
        guaranteed = rsPlayerGuaranteedTable { "obj.gauntlet_crystal_shard_hm" count 50..100 },
        mainTable =
            rsPlayerWeightedTable(total = 21) {
                name("Corrupted Unicorn Drops")
