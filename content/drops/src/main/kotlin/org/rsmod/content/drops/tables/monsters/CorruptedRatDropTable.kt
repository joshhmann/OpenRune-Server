...
@JvmField
public val corruptedRatDropTable: RSDropTable<Player, DropRollItem> =
    RSDropTable(
        tableIdentifier = "Corrupted Rat Drops",
        npcs = npcs("npc.crystal_rat_hm"),
        guaranteed = rsPlayerGuaranteedTable { "obj.gauntlet_crystal_shard_hm" count 10..30 },
        mainTable =
            rsPlayerWeightedTable(total = 24) {
                name("Corrupted Rat Drops")
