...
@JvmField
public val greaterSkeletonHellhoundVetionDropTable: RSDropTable<Player, DropRollItem> =
    RSDropTable(
        tableIdentifier = "Greater Skeleton Hellhound (Vet'ion) Drops",
        npcs = npcs("npc.vetion_hellhound_snr"),
        tertiaries =
