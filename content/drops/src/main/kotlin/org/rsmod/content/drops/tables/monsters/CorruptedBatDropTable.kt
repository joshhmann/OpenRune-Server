...
@JvmField
public val corruptedBatDropTable: RSDropTable<Player, DropRollItem> =
    RSDropTable(
        tableIdentifier = "Corrupted Bat Drops",
        npcs = npcs("npc.crystal_bat_hm"),
        guaranteed = rsPlayerGuaranteedTable { "obj.gauntlet_crystal_shard_hm" count 10..30 },
        mainTable =
            rsPlayerWeightedTable(total = 24) {
                name("Corrupted Bat Drops")
