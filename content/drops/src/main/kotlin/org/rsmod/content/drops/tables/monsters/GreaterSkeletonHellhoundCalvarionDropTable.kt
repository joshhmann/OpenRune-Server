...
@JvmField
public val greaterSkeletonHellhoundCalvarionDropTable: RSDropTable<Player, DropRollItem> =
    RSDropTable(
        tableIdentifier = "Greater Skeleton Hellhound (Calvar'ion) Drops",
        npcs = npcs("npc.vetion_hellhound_snr_singles"),
        tertiaries =
