...
@JvmField
public val caveGoblinGuardDropTable: RSDropTable<Player, DropRollItem> =
    RSDropTable(
        tableIdentifier = "Cave goblin guard Drops",
        npcs = npcs("npc.cave_goblin_guard1", "npc.cave_goblin_guard2"),
        mainTable =
            rsPlayerWeightedTable(total = 148) {
                name("Cave goblin guard Drops")
                20 weight
                    "obj.cave_goblin_bone_club" count
                    1 condition
                    { player ->
                        // Drops Need Manual: Bone clubs only drop from the level 24 bone
                ...
                20 weight
                    ...
                    1 condition
                    { player ->
                        // Drops Need Manual: Bone spears only drop from the level 26 bone
                        // club-wielding guards.
                        true
                    }
