...
@JvmField
public val skeletonHellhoundCalvarionDropTable: RSDropTable<Player, DropRollItem> =
    RSDropTable(
        tableIdentifier = "Skeleton Hellhound (Calvar'ion) Drops",
        npcs = npcs("npc.vetion_hellhound_jnr_singles"),
        tertiaries =
