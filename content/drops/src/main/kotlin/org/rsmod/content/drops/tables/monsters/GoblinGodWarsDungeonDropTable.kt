...
@JvmField
public val goblinGodWarsDungeonDropTable: RSDropTable<Player, DropRollItem> =
    RSDropTable(
        tableIdentifier = "Goblin (God Wars Dungeon) Drops",
        npcs =
            npcs(
                "npc.godwars_goblin1",
                "npc.godwars_goblin2",
        ...
        mainTable =
            rsPlayerWeightedTable(total = 128) {
                name("Goblin (God Wars Dungeon) Drops")
