...
@JvmField
public val zaklnGritchDropTable: RSDropTable<Player, DropRollItem> =
    RSDropTable(
        tableIdentifier = "Zakl'n Gritch Drops",
        npcs = npcs("npc.godwars_ancient_lesser_demon"),
        mainTable =
            rsPlayerWeightedTable(total = 127) {
                name("Zakl'n Gritch Drops")
        ...
        tertiaries =
            rsPlayerTertiaryTable {
                ...
                1 outOf
                    ...
                    1 condition
                    { player ->
                        // Drops Need Manual: Champion scrolls are only dropped if access to
                        // Champions' Guild is available, and the Lesser Demon Champion hasn't been
