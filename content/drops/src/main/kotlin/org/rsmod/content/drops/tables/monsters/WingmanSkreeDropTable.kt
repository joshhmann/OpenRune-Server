...
@JvmField
public val wingmanSkreeDropTable: RSDropTable<Player, DropRollItem> =
    RSDropTable(
        tableIdentifier = "Wingman Skree Drops",
        npcs = npcs("npc.godwars_armadyl_bodyguard_skree"),
        guaranteed = rsPlayerGuaranteedTable { "obj.feather" count 1..11 },
        mainTable =
            rsPlayerWeightedTable(total = 127) {
                name("Wingman Skree Drops")
