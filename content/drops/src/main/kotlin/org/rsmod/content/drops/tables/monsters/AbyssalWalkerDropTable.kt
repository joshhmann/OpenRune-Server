...
@JvmField
public val abyssalWalkerDropTable: RSDropTable<Player, DropRollItem> =
    RSDropTable(
        tableIdentifier = "Abyssal walker Drops",
        npcs = npcs("npc.abyssal_walker"),
        mainTable =
            rsPlayerWeightedTable(total = 256) {
                name("Abyssal walker Drops")
        ...
        tertiaries =
            rsPlayerTertiaryTable {
                1 outOf 40 weight "obj.arceuus_corpse_abyssal" count 1
                1 outOf
                    243 weight
