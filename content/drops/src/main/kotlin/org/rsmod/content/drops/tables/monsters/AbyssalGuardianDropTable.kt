...
@JvmField
public val abyssalGuardianDropTable: RSDropTable<Player, DropRollItem> =
    RSDropTable(
        tableIdentifier = "Abyssal guardian Drops",
        npcs = npcs("npc.abyssal_pyramid"),
        mainTable =
            rsPlayerWeightedTable(total = 256) {
                name("Abyssal guardian Drops")
