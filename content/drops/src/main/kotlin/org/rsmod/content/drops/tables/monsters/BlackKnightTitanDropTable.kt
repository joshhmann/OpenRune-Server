...
@JvmField
public val blackKnightTitanDropTable: RSDropTable<Player, DropRollItem> =
    RSDropTable(
        tableIdentifier = "Black Knight Titan Drops",
        npcs = npcs("npc.black_knight_titan"),
        mainTable =
            rsPlayerWeightedTable(total = 128) {
                name("Black Knight Titan Drops")
