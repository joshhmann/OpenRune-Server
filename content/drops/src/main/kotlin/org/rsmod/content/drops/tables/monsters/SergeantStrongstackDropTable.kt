...
@JvmField
public val sergeantStrongstackDropTable: RSDropTable<Player, DropRollItem> =
    RSDropTable(
        tableIdentifier = "Sergeant Strongstack Drops",
        npcs = npcs("npc.godwars_sergeant_goblin1"),
        mainTable =
            rsPlayerWeightedTable(total = 127) {
                name("Sergeant Strongstack Drops")
        ...
        tertiaries =
            rsPlayerTertiaryTable {
                1 outOf 6 weight "obj.kebab" count 1
                1 outOf
                    20 weight
