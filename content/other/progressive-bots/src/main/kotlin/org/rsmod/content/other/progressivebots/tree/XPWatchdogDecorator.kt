...
/**
 * Decorator that tracks XP drops for a specific stat. If a bot goes [maxTicksWithoutXp] ticks
 * without gaining XP, it aborts the current behavior. This acts as a fallback to prevent silent
 * pathing or interaction failures.
 */
