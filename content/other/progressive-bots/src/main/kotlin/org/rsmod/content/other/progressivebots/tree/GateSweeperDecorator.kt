 ...
 * within a 3-tile radius if they are closed.
            ...
            for (z in -1..1) {
                ...
                for (loc in locs) {
                    ...
                    if (name.contains("door") || name.contains("gate")) {
                        // Check if the door is closed (Option 1 is "Open")
                        val op1 = type.actions.getOpOrNull(0)
                        val isClosed = op1?.equals("Open", ignoreCase = true) == true
