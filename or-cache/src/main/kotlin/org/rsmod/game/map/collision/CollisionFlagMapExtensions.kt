...
public fun CollisionFlagMap.addLoc(loc: LocInfo, type: ObjectServerType): Unit =
    toggleLoc(loc, type, add = true)

public fun CollisionFlagMap.removeLoc(loc: LocInfo, type: ObjectServerType): Unit =
    toggleLoc(loc, type, add = false)

public fun CollisionFlagMap.toggleLoc(loc: LocInfo, type: ObjectServerType, add: Boolean) {
    toggleLoc(
        coords = loc.coords,
        width = type.width,
        length = type.length,
